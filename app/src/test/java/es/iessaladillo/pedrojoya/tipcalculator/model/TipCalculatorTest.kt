...
class TipCalculatorTest {
    ...
    fun `should calculate perDinerRounded properly when perDinerRounded has 00 as cents`() {
        assertEquals(55.00.toFloat(), TipCalculator(100f, 10f, 2).calculatePerDinerRounded())
    }
